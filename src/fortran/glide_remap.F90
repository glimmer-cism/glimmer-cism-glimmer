! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
! +                                                           + 
! +  glide_remap.F90 - part of the GLIMMER ice model          + 
! +                                                           + 
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
! 
! Copyright (C) 2006 GLIMMER contributors - see COPYRIGHT file 
...
!
! These routines are based on the incremental remapping scheme
! in CICE 4.0, a sea ice model developed at LANL.  See these references:
! 
...
!--------------------------------------------------------------  
      ...
      implicit none
      private
      public :: remap_driver, init_remap
      public :: c0, c1, p5, eps  !lipscomb - should be declared elsewhere?
...
!      integer, parameter ::   &
!           itest = 36, jtest = 31, dij = 1, ktest = 1 

!lipscomb - numerical constants from CICE
!lipscomb - Perhaps these should be declared elsewhere 
...
!=======================================================================
      ...
      real(dp), dimension (nx_block, ny_block, ntrace), intent(inout) :: &
           trcr      ! tracer fields
      ...
      real (dp), dimension (nx_block,ny_block,ntrace) ::     &
...
!
      ...
      real (dp), dimension(ntrace), intent(out) ::        &
...
!
      ...
      real (dp), dimension(ntrace), intent(in), optional ::  &
         htsum_init  ,&! initial global ice volume*tracer
         htsum_final   ! final global ice volume*tracer
