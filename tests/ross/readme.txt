...
the x and y coordonates of the nodes and 10 interpolated fields of data:
...
The velocities (uxbar,uybar) in the grid coordonate system are thus given
by the relationship:
...
been found in the litterature. The value of the velocity magnitude and
...
is more than five hundred kilometers lengh. This file gives the index
of the grid points on the "30 kilometers lengh" ice front.
