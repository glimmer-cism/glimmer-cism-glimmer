...
appropriate). This is illustrated schematically in figure~\ref{ug.figs.glint_timesteps}.  
%
\begin{figure}[htbp]
  \centering
...
\subsubsection{API}
%
A detailed description of the GLINT API will form an appendix to this document
at some point.
%
...
%%%% 
    ...
    \texttt{acab\_mode} & {\raggedright
      ...
      \begin{tabular}{lp{7cm}}
        {\bf 1} & Annual PDD mass-balance model \\
